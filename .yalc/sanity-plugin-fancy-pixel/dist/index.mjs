...
const scale = "1px", speed = "1s", pink = "#ff99ff", tan = "#ffcc99", magenta = "#ff3399", gray = "#999999", peach = "#ff9999", sky = "#003366", red = "#ff0000", orange = "#ff9900", yellow = "#ffff00", green = "#33ff00", lightBlue = "#0099ff", blue = "#6636ff", NyanCatStyles = createGlobalStyle`
// ==================================
// Layout, General
// ==================================
...
`, NyanCat = () => {
  const [currentIndex, setCurrentIndex] = useState(0), positions = ["minimal", "left", "middle", "right"], handleClick = () => {
    setCurrentIndex((prevIndex) => (prevIndex + 1) % positions.length);
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(NyanCatStyles, {}),
    /* @__PURE__ */ jsxs("div", { id: "nyanCatOverly", className: `overlay cat-${positions[currentIndex]}`, children: [
      /* @__PURE__ */ jsx("div", { className: "rainbow", children: /* @__PURE__ */ jsx("div", { className: "sprite" }) }),
      /* @__PURE__ */ jsx("button", { type: "button", className: "button--no-display", onClick: handleClick, children: /* @__PURE__ */ jsxs("div", { className: "cat", children: [
        /* @__PURE__ */ jsx("div", { className: "tail", children: /* @__PURE__ */ jsx("div", { className: "sprite" }) }),
        /* @__PURE__ */ jsx("div", { className: "feet", children: /* @__PURE__ */ jsx("div", { className: "sprite" }) }),
        /* @__PURE__ */ jsx("div", { className: "poptart" }),
        /* @__PURE__ */ jsx("div", { className: "head" })
      ] }) })
    ] })
  ] });
};
function FancyPixelNavbar(props) {
  return /* @__PURE__ */ jsxs(Stack, { children: [
    ...
    " ",
    /* @__PURE__ */ jsx(NyanCat, {})
  ] });
}
const fancyPixelPlugin = definePlugin({
